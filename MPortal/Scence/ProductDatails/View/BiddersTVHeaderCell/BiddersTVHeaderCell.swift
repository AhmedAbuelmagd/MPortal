...
import UIKit
import MOLH
class BiddersTVHeaderCell: UITableViewHeaderFooterView {
    ...
    override func awakeFromNib() {
        ...
        biddersLbl.customLabel(color: .C1D1D1D, size: .size_14, font: .W500, text: LBLs.BIDDERS.title)
