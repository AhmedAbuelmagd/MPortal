...
extension ProductDatailsVC{
    func initUI(){
        ...
        auctionNameLbl.customLabel(color: .C1D1D1D, size: .size_18, font: .W600, text: LBLs.AUCTION_NAME.title)
        auctionCodeLbl.customLabel(color: .C808080, size: .size_13, font: .W300, text: "code 1234")
        auctionDetailsLbl.customLabel(color: .CD20653, size: .size_14, font: .W400, text: LBLs.AUCTION_DETAILS.title)
        auctionRateLbl.customLabel(color: .CD20653, size: .size_14, font: .W400, text: LBLs.AUCTION_RATE.title)
        auctionPriceNowLbl.customLabel(color: .C808080, size: .size_13, font: .W300, text: LBLs.AUCTION_CURRENT_PRICE.title)
        auctionPriceAfterTaxLbl.customLabel(color: .C808080, size: .size_13, font: .W300, text: LBLs.AUCTION_CURRENT_PRICE_TAX.title)
        priceNowTitleLbl.customLabel(color: .C1D1D1D, size: .size_13, font: .W600, text: LBLs.AUCTION_PRICE_NOW.title)
        ...
        dayLbl.customLabel(color: .CFDBC01, size: .size_08, font: .W600, text: LBLs.DAY.title)
        hourLbl.customLabel(color: .CFDBC01, size: .size_08, font: .W600, text: LBLs.FULL_HOUR.title)
        minuteLbl.customLabel(color: .CFDBC01, size: .size_08, font: .W600, text: LBLs.FULL_MINUTE.title)
        ...
        startAfterLbl.customLabel(color: .C808080, size: .size_11, font: .W300, text: LBLs.START_AFTER.title)
        dateLbl.customLabel(color: .C808080, size: .size_11, font: .W300, text: LBLs.AUCTION_DATE.title)
